...
<a href="http://nodejs.org/download/"><img src="https://img.shields.io/node/v/finalhandler.svg" alt="Node.js Version"></a>
...
<h2>Installation</h2><pre><code class="language-sh">$ npm install finalhandler
</code></pre>
...
be written out to the <code>res</code>, and <code>res.statusCode</code> is set from <code>err.status</code>.</p>
