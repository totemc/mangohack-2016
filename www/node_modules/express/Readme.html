...
<h2>Installation</h2><pre><code class="language-bash">$ npm install express
</code></pre>
<h2>Features</h2><ul>
...
<h2>Quick Start</h2><p>  The quickest way to get started with express is to utilize the executable <a href="https://github.com/expressjs/generator"><code>express(1)</code></a> to generate an application as shown below:</p>
...
<h2>Philosophy</h2><p>  The Express philosophy is to provide small, robust tooling for HTTP servers, making
...
<h2>Examples</h2><p>  To view the examples, clone the Express repo and install the dependencies:</p>
...
<h2>Tests</h2><p>  To run the test suite, first install the dependencies, then run <code>npm test</code>:</p>
<pre><code class="language-bash">$ npm install
$ npm test
</code></pre>
<h2>People</h2><p>The original author of Express is <a href="https://github.com/tj">TJ Holowaychuk</a> <a href="https://gratipay.com/visionmedia/"><img src="https://img.shields.io/gratipay/visionmedia.svg" alt="TJ&#39;s Gratipay"></a></p>
