<h1>serve-static</h1><p><a href="https://npmjs.org/package/serve-static"><img src="https://img.shields.io/npm/v/serve-static.svg" alt="NPM Version"></a>
...
<h2>Install</h2><pre><code class="language-sh">$ npm install serve-static
</code></pre>
<h2>API</h2><pre><code class="language-js">var serveStatic = require(&#39;serve-static&#39;)
</code></pre>
<h3>serveStatic(root, options)</h3><p>Create a new middleware function to serve files from within a given root
...
<h4>Options</h4><h5>dotfiles</h5><p> Set how &quot;dotfiles&quot; are treated when encountered. A dotfile is a file
...
<h5>etag</h5><p>Enable or disable etag generation, defaults to true.</p>
<h5>extensions</h5><p>Set file extension fallbacks. When set, if a file is not found, the given
extensions will be added to the file name and search for. The first that
exists will be served. Example: <code>[&#39;html&#39;, &#39;htm&#39;]</code>.</p>
<p>The default value is <code>false</code>.</p>
<h5>fallthrough</h5><p>Set the middleware to have client errors fall-through as just unhandled
...
<h5>index</h5><p>By default this module will send &quot;index.html&quot; files in response to a request
...
<h5>lastModified</h5><p>Enable or disable <code>Last-Modified</code> header, defaults to true. Uses the file
system&#39;s last modified value.</p>
<h5>maxAge</h5><p>Provide a max-age in milliseconds for http caching, defaults to 0. This
can also be a string accepted by the <a href="https://www.npmjs.org/package/ms#readme">ms</a>
module.</p>
<h5>redirect</h5><p>Redirect to trailing &quot;/&quot; when the pathname is a dir. Defaults to <code>true</code>.</p>
<h5>setHeaders</h5><p>Function to set custom headers on response. Alterations to the headers need to
...
<h2>Examples</h2><h3>Serve files with vanilla node.js http server</h3><pre><code class="language-js">var finalhandler = require(&#39;finalhandler&#39;)
...
<h3>Serve all files as downloads</h3><pre><code class="language-js">var contentDisposition = require(&#39;content-disposition&#39;)
...
<h3>Serving using express</h3><h4>Simple</h4><p>This is a simple example of using Express.</p>
...
<h4>Multiple roots</h4><p>This example shows a simple way to search through multiple directories.
...
<h4>Different settings for paths</h4><p>This example shows how to set a different max age depending on the served
