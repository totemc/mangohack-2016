<h1>type-is</h1><p><a href="https://npmjs.org/package/type-is"><img src="https://img.shields.io/npm/v/type-is.svg" alt="NPM Version"></a>
...
<h3>Install</h3><pre><code class="language-sh">$ npm install type-is
</code></pre>
<h2>API</h2><pre><code class="language-js">var http = require(&#39;http&#39;)
...
<h3>type = is(request, types)</h3><p><code>request</code> is the node HTTP request. <code>types</code> is an array of types.</p>
...
<h3>is.hasBody(request)</h3><p>Returns a Boolean if the given <code>request</code> has a body, regardless of the
...
<pre><code class="language-js">if (is.hasBody(req)) {
...
<h3>type = is.is(mediaType, types)</h3><p><code>mediaType</code> is the <a href="https://tools.ietf.org/html/rfc6838">media type</a> string. <code>types</code> is an array of types.</p>
...
<h2>Examples</h2><h4>Example body parser</h4><pre><code class="language-js">var is = require(&#39;type-is&#39;);
