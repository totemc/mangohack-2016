...
<h2>Install</h2><pre><code class="language-sh">$ npm install mime-types
</code></pre>
<h2>Adding Types</h2><p>All mime types are based on <a href="https://github.com/jshttp/mime-db">mime-db</a>,
