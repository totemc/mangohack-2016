<h1>Path-to-RegExp</h1><p>Turn an Express-style path string such as <code>/user/:name</code> into a regular expression.</p>
<p><strong>Note:</strong> This is a legacy branch. You should upgrade to <code>1.x</code>.</p>
<h2>Usage</h2><pre><code class="language-javascript">var pathToRegexp = require(&#39;path-to-regexp&#39;);
</code></pre>
<h3>pathToRegexp(path, keys, options)</h3><ul>
