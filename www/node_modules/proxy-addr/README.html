<h1>proxy-addr</h1><p><a href="https://npmjs.org/package/proxy-addr"><img src="https://img.shields.io/npm/v/proxy-addr.svg" alt="NPM Version"></a>
...
<h2>Install</h2><pre><code class="language-sh">$ npm install proxy-addr
</code></pre>
<h2>API</h2><pre><code class="language-js">var proxyaddr = require(&#39;proxy-addr&#39;)
</code></pre>
<h3>proxyaddr(req, trust)</h3><p>Return the address of the request, using the given <code>trust</code> parameter.</p>
...
<h3>proxyaddr.all(req, [trust])</h3><p>Return all the addresses of the request, optionally stopping at the
...
<h3>proxyaddr.compile(val)</h3><p>Compiles argument <code>val</code> into a <code>trust</code> function. This function takes
...
<h2>Benchmarks</h2><pre><code class="language-sh">$ npm run-script bench
</code></pre>
